...
public class FatturaElettronicaSemplice {
	...
	public static FatturaElettronicaType newNotaCredito() throws DatatypeConfigurationException {
		FatturaElettronicaType fatturaElettronica = newFattura();
		fatturaElettronica.getFatturaElettronicaBody().get(0).getDatiGenerali().getDatiGeneraliDocumento().setTipoDocumento(TipoDocumentoType.TD_04);
		return fatturaElettronica;
	}
	
	public static FatturaElettronicaType newFatturaPA() throws DatatypeConfigurationException {
		FatturaElettronicaType fatturaElettronica = newFattura();
		fatturaElettronica.setVersione(FormatoTrasmissioneType.FPA_12);
		DatiTrasmissioneType datiTrasmissione = fatturaElettronica.getFatturaElettronicaHeader().getDatiTrasmissione();
			datiTrasmissione.setFormatoTrasmissione(FormatoTrasmissioneType.FPA_12);
			datiTrasmissione.setCodiceDestinatario("000000");
			datiTrasmissione.setPECDestinatario(null);
			fatturaElettronica.getFatturaElettronicaHeader().setDatiTrasmissione(datiTrasmissione);
		return fatturaElettronica;
	}
	
	public static FatturaElettronicaType newFatturaEstera() throws DatatypeConfigurationException {
		...
		FatturaElettronicaHeaderType fatturaElettronicaHeader = new FatturaElettronicaHeaderType();
			...
			CessionarioCommittenteType cessionarioCommittente = new CessionarioCommittenteType();
				DatiAnagraficiCessionarioType datiAnagraficiCessionario = new DatiAnagraficiCessionarioType();
					IdFiscaleType idFiscaleCessionario = new IdFiscaleType();
						idFiscaleCessionario.setIdPaese("FR");
